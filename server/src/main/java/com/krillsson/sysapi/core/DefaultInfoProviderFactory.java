...
public class DefaultInfoProviderFactory {
    ...
    public boolean initialize() {
        ...
        setNetworkInfoProvider(new DefaultNetworkProvider(hal, speedMeasurementManager));
        setGpuInfoProvider(new DefaultGpuInfoProvider(hal));
        setDiskInfoProvider(new DefaultDiskProvider(operatingSystem, hal, speedMeasurementManager));
