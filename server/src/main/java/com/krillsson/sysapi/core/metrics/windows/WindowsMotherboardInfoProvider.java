...
import com.krillsson.sysapi.core.metrics.defaultimpl.DefaultMotherboardInfoProvider;
...
public class WindowsMotherboardInfoProvider extends DefaultMotherboardInfoProvider {
    private final MonitorManager monitorManager;

    public WindowsMotherboardInfoProvider(HardwareAbstractionLayer hal, MonitorManager monitorManager) {
        super(hal);
