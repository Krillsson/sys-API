...
class DriveWriteRateMonitor(override val id: UUID, override val config: MonitorConfig) : Monitor() {
    override val type: MonitorType = MonitorType.DRIVE_WRITE_RATE
    ...
    override fun selectValue(event: MonitorMetricQueryEvent): Double = event.load().driveLoads
            ...
            .speed.writeBytesPerSecond.toDouble()
