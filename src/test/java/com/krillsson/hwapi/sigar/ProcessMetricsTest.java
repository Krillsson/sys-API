...
import com.krillsson.hwapi.representation.processes.*;
import com.krillsson.hwapi.representation.processes.Process;
...
public class ProcessMetricsTest {
    ...
    public void getProcessListHappyPath() throws Exception {
        setupProcessMock();
        List<com.krillsson.hwapi.representation.processes.Process> processes = processMetrics.getProcesses();
