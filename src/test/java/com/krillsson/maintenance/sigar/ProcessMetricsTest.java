...
import com.krillsson.maintenance.representation.processes.*;
...
public class ProcessMetricsTest {
    ...
    public void getProcessListHappyPath() throws Exception {
        setupProcessMock();
        List<com.krillsson.maintenance.representation.processes.Process> processes = processMetrics.getProcesses();
