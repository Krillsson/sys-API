...
public class ProcessSigarTest {

    private static final long process1Pid = 123L;
    private Sigar sigar;
    private ProcessSigar processSigar;
    ...
    public void getProcessListHappyPath() throws Exception {
        setupProcessMock();
        List<com.krillsson.sysapi.representation.processes.Process> processes = processSigar.getProcesses();
    ...
    public void getProcessListNoProcesses() throws Exception {
        ...
        List<Process> processes = processSigar.getProcesses();
    ...
    public void getProcessByPidHappyPath() throws Exception {
        setupProcessMock();
        Process processByPid = processSigar.getProcessByPid(process1Pid);
    ...
    public void getProcessByPidNonExistingProcessShouldThrowException() throws Exception {
        when(sigar.getProcList()).thenReturn(new long[0]);
        processSigar.getProcessByPid(124L);
    }
