...
import se.krillsson.maintenance.representation.processes.*;
import se.krillsson.maintenance.representation.processes.Process;
...
public class ProcessMetricsTest {
    ...
    public void getProcessListHappyPath() throws Exception {
        setupProcessMock();
        List<se.krillsson.maintenance.representation.processes.Process> processes = processMetrics.getProcesses();
