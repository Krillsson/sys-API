...
import se.krillsson.maintenance.representation.network.NetworkInfo;
import se.krillsson.maintenance.representation.network.NetworkInterfaceConfig;
import se.krillsson.maintenance.representation.network.NetworkInterfaceSpeed;
import se.krillsson.maintenance.representation.network.NetworkInterfaceStatistics;
